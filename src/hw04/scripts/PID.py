...
class PID:
    ...
    def __init__(self, P=np.array([1.0, 1.0, 1.0]), I=np.array([0.0, 0.0, 0.0]), D=np.array([0.0, 0.0, 0.0]),samplingTime=0):
    ...
    def clear(self):
        ...
        self.setSetPoint(np.array([0.0, 0.0, 0.0]))

        self.setIntegral(np.array([0.0, 0.0, 0.0]))

        self.setLastError(np.array([0.0, 0.0, 0.0]))
